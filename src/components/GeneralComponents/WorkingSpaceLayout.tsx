...
import SingleWspaceAside from '../WspaceComponents/SingleWspaceAside';
...
import WspaceDescription from '../WspaceComponents/WspaceDescription';

export const WspaceLayoutContext = createContext<SingleWorkingSpaceType | undefined>({} as SingleWorkingSpaceType);
...
export default function WorkingSpaceLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <WspaceLayoutContext.Provider value={data}>
